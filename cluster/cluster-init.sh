...
echo ""
echo "Next steps:"
echo "  cluster-ctl.sh ${CLUSTER_NAME} start      # launch server + nodes"
echo "  cluster-ctl.sh ${CLUSTER_NAME} stop       # stop all daemons"
echo "  cluster-destroy.sh ${CLUSTER_NAME}        # teardown everything"
